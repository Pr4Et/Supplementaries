%Reorder files CH*.mrc (includ. HAADF) that were acquired in dose symmetric fashion by SerialEM
...
first_chan=input('First channel number= ');
angle_vector=0;
if ds_ISupto
    ve=0:stepa:maxa;
...
for channel=first_chan:7
    Chosen_Filename=strrep(Chosen_Filename_ch1,'CH1',sprintf('CH%d',channel));
    %Chosen_Filename=Chosen_Filename_ch1;%strrep(Chosen_Filename_ch1,'CH0.mrc',sprintf('CH%d.mrc',channel));
