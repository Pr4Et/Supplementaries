...
if contains(Chosen_Filename_ali,'_jali.mrc')
    newFilename=strrep(Chosen_Filename_ali,'_jali.mrc','_rec_SIRTN.mrc');
elseif contains(Chosen_Filename_ali,'_ali.mrc')
    newFilename=strrep(Chosen_Filename_ali,'_ali.mrc','_rec_SIRTN.mrc');
elseif contains(Chosen_Filename_ali,'.mrc')
    newFilename=strrep(Chosen_Filename_ali,'.mrc','_rec_SIRTN.mrc');
else
    newFilename=[Chosen_Filename_ali '_rec_SIRTN.mrc'];
end
