%Script to find best thickness of protective layer for optimum transmission of ultrasound, given the requested frequency and the properties of the protective layer
...
for t_smd=t_smd_vect
    grand_n=grand_n+1;
    V=10; %amplitude of electrical voltage
    ...
    s33_pzt=14.2*1e-12;
    t_pzt=4.2*1e-3;%4.2mm for 500KHz
...
figure(3)
[hAx,hLine1,hLine2] =plotyy(t_smd_vect*1000,grand_acoustic,t_smd_vect*1000,grand_pzt);
xlabel('Titanium thickness [mm]');
ylabel(hAx(1),'Acoustic emitted power [W]');
