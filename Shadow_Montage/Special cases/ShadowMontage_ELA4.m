...
required_nX=4096;%input('required nX: ');
required_nY=4096;%input('required nY: ');
...
newFilename=strrep(Chosen_Filename,'.mrc',sprintf('_series_%gx%g.mrc',required_nX,required_nX));
newmRCImage = MRCImage;%Instentiate MRCImage object
newmRCImage.filename=newFilename;
