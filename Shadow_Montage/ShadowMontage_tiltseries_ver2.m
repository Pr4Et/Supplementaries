...
% such as produced by SavvyScan with DECTRIS Arina. Each tiltview is identified in the
% filename by S#, starting from number 0. The order of the tiltviews is acco0rding to order of acquisition.
% Written by Shahar Seifer, Weizmann Institute of Science, 2025-2026
    ...
    CTFcorrect=1;%input('Apply CTF correction? (0-no, 1-yes');
    save_3d_backprojections=input('Save 3d backprojections for each tiltview? (0-no, 1-yes):');
    
    
    [filename,path] = uigetfile('z:\shared\ArinaData\*00001.h5','Fetch first HD5 file of s0 projection');
    
    ToUseALN=0;%input('Use aln file from AreTomo for initial alignment (1) or skip (0): ');
